...
export class PlacementService {
    public static calculPositionCentreZoneDepart(premierSegment: Array<THREE.Vector3>): THREE.Vector2 {
    ...
    public static calculPositionVoiture(cadranX: number, cadranY: number, premierSegment: Array<THREE.Vector3>): THREE.Vector2 {
    ...
    public static obtenirVecteursSensPiste(premierSegment: Array<THREE.Vector3>): THREE.Vector2 {
    ...
    public static obtenirVecteurAvanceSensPiste(premierSegment: Array<THREE.Vector3>): THREE.Vector2 {
